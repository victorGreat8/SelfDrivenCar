...
function polyIntersect(poly1, poly2){ // polyIntersect is a function that takes in two parameters: poly1 and poly2. poly1 and poly2 are arrays of points that define the vertices of the two polygons. The function returns true if the two polygons intersect, and false if they do not.
